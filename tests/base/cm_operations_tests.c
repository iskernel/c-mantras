...
{
    struct cm_operation_status* status = cm_operation_status_create(
            CM_OPERATION_CODE_FAILED, "Message");
...
static void cm_operation_stack_create__normal_scenario__is_created(void)
{
    ...
    bool condition = (stack->data != NULL) && (stack->index == 0U)
            && (stack->length == 10U);
...
static void cm_operation_stack_set_last__no_existing_operations__is_added(void)
{
    ...
    condition = (strcmp(stack->data[stack->index]->message, "Message") == 0)
            && (stack->data[stack->index]->operation_code
                    == CM_OPERATION_CODE_FAILED);
    assert_is_true(condition, __func__);
...
static void cm_operation_stack_set_last__operations_already_added__is_added_corectly(
        void)
{
    struct cm_operation_stack* stack = cm_operation_stack_create(10U);
    struct cm_operation_status* status_1 = cm_operation_status_create(
            CM_OPERATION_CODE_FAILED, "Message");
    struct cm_operation_status* status_2 = cm_operation_status_create(
            CM_OPERATION_CODE_FAILED, "Message1");
    struct cm_operation_status* status_3 = cm_operation_status_create(
            CM_OPERATION_CODE_FAILED, "Message2");
    bool condition = false;
...
static void cm_operation_stack_set_last__overflow__is_restarted(void)
{
    ...
    struct cm_operation_status* status_3 = cm_operation_status_create(
            CM_OPERATION_CODE_FAILED, "Message2");
    struct cm_operation_status* status_4 = cm_operation_status_create(
            CM_OPERATION_CODE_FAILED, "Message3");
    struct cm_operation_status* status_5 = cm_operation_status_create(
            CM_OPERATION_CODE_FAILED, "Message4");
    struct cm_operation_status* status_6 = cm_operation_status_create(
            CM_OPERATION_CODE_FAILED, "Message5");
    struct cm_operation_status* status_7 = cm_operation_status_create(
            CM_OPERATION_CODE_FAILED, "Message6");
    struct cm_operation_status* status_8 = cm_operation_status_create(
            CM_OPERATION_CODE_FAILED, "Message7");
    struct cm_operation_status* status_9 = cm_operation_status_create(
            CM_OPERATION_CODE_FAILED, "Message8");
    struct cm_operation_status* status_10 = cm_operation_status_create(
            CM_OPERATION_CODE_FAILED, "Message9");
    struct cm_operation_status* status_11 = cm_operation_status_create(
            CM_OPERATION_CODE_FAILED, "Message10");
    bool condition = false;
...
static void cm_operation_stack_get_last__overflow__is_retrieved(void)
{
    ...
    struct cm_operation_status* status_11 = cm_operation_status_create(
            CM_OPERATION_CODE_FAILED, "Message10");
    struct cm_operation_status* status_12 = cm_operation_status_create(
            CM_OPERATION_CODE_FAILED, "Message11");
    struct cm_operation_status* status_13 = cm_operation_status_create(
            CM_OPERATION_CODE_FAILED, "Message12");
    struct cm_operation_status* status_14 = cm_operation_status_create(
            CM_OPERATION_CODE_FAILED, "Message13");

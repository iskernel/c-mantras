...
static void cm_search_array_linear__element_exists__is_found(void)
{
    ...
    index = cm_search_array_linear(&(int ) { 2 }, array->elements, 5,
                                   &compare_ints);
...
static void cm_search_array_sentinel_linear__element_exists__is_found(void)
{
    ...
    cm_array_set(array, &(int ) { 4 }, 3);
    cm_array_set(array, &(int ) { 5 }, 4);
    index = cm_search_array_sentinel_linear(&(int ) { 2 }, array->elements, 5,
                                            &compare_ints);
...
static void cm_search_array_binary__element_exists__is_found(void)
{
    ...
    cm_array_set(array, &(int ) { 4 }, 3);
    cm_array_set(array, &(int ) { 5 }, 4);
    index = cm_search_array_binary(&(int ) { 2 }, array->elements, 5,
                                   &compare_ints);
...
static void cm_search_array_improved_binary__element_exists__is_found(void)
{
    ...
    cm_array_set(array, &(int ) { 4 }, 3);
    cm_array_set(array, &(int ) { 5 }, 4);
    index = cm_search_array_improved_binary(&(int ) { 2 }, array->elements, 5,
                                            &compare_ints);
...
static void cm_search_array_interpolation__element_exists__is_found(void)
{
    ...
    cm_array_set(array, &(int ) { 4 }, 3);
    cm_array_set(array, &(int ) { 5 }, 4);
    index = cm_search_array_interpolation(&(int ) { 2 }, array->elements, 5,
                                          &compare_ints);
...
static void cm_search_array_linear__element_does_not_exist__not_found(void)
{
    ...
    cm_array_set(array, &(int ) { 4 }, 3);
    cm_array_set(array, &(int ) { 5 }, 4);
    index = cm_search_array_linear(&(int ) { -1 }, array->elements, 5,
                                   &compare_ints);
...
static void cm_search_array_sentinel_linear__element_does_not_exist__not_found(
        void)
{
    struct cm_array* array = cm_array_create(10);
    ...
    cm_array_set(array, &(int ) { 4 }, 3);
    cm_array_set(array, &(int ) { 5 }, 4);
    index = cm_search_array_sentinel_linear(&(int ) { -1 }, array->elements, 5,
                                            &compare_ints);
...
static void cm_search_array_binary__element_does_not_exist__not_found(void)
{
    ...
    cm_array_set(array, &(int ) { 4 }, 3);
    cm_array_set(array, &(int ) { 5 }, 4);
    index = cm_search_array_binary(&(int ) { -1 }, array->elements, 5,
                                   &compare_ints);
...
static void cm_search_array_improved_binary__element_does_not_exist__not_found(
        void)
{
    struct cm_array* array = cm_array_create(10);
    ...
    cm_array_set(array, &(int ) { 4 }, 3);
    cm_array_set(array, &(int ) { 5 }, 4);
    index = cm_search_array_improved_binary(&(int ) { -1 }, array->elements, 5,
                                            &compare_ints);
...
static void cm_search_array_interpolation__element_does_not_exist__not_found(
        void)
{
    struct cm_array* array = cm_array_create(10);
    ...
    cm_array_set(array, &(int ) { 4 }, 3);
    cm_array_set(array, &(int ) { 5 }, 4);
    index = cm_search_array_interpolation(&(int ) { -1 }, array->elements, 5,
                                          &compare_ints);

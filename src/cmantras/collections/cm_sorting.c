...
static cm_index cm_sort_array_quicksort_partition (void** array, cm_index left, cm_index right,
...
void cm_sort_array_quicksort (void** array, cm_size array_size, cm_cmp_size (*compare)(const void*, const void*))
{
    ...
    while ( top >= 0 )
    {
        ...
        pivot = cm_sort_array_quicksort_partition( array, left, array_size, compare );

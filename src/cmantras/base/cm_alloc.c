#include"cmantras/base/cm_alloc.h"
...
void**** cm_nalloc_4d(void ****vector, size_t x_size, size_t y_size, size_t z_size, size_t t_size, size_t element_size)
{
	int i,j,k;
